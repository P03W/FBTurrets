...
class FBTurrets : ModInitializer {
    ...
    companion object {
        ...
        @JvmField
		var TURRET_HOLDER_MODEL: Block? = null
        var BASIC_GUN: TurretGun? = null
        var SNIPER_GUN: TurretGun? = null
        var AUTO_GUN: TurretGun? = null
        @JvmField
		val TURRET_HOLDER = TurretHolder(FabricBlockSettings.of(Material.BARRIER).hardness(4.0f).nonOpaque())
        @JvmField
		var TURRET_HOLDER_BLOCK_ENTITY: BlockEntityType<TurretHolderBlockEntity>? = null
    }
}